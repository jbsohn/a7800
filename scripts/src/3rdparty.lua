...
if _OPTIONS["targetos"]=="android" then
	...
	files {
		...
		MAME_DIR .. "3rdparty/SDL2/src/SDL_list.c",
		...
		MAME_DIR .. "3rdparty/SDL2/src/joystick/SDL_steam_virtual_gamepad.c",
		...
		MAME_DIR .. "3rdparty/SDL2/src/render/software/SDL_triangle.c",
		MAME_DIR .. "3rdparty/SDL2/src/video/SDL_yuv.c",
		MAME_DIR .. "3rdparty/SDL2/src/video/yuv2rgb/yuv_rgb_std.c",
		MAME_DIR .. "3rdparty/SDL2/src/video/yuv2rgb/yuv_rgb_sse.c",
		...
		MAME_DIR .. "3rdparty/SDL2/src/joystick/hidapi/SDL_hidapi_combined.c",
		MAME_DIR .. "3rdparty/SDL2/src/joystick/hidapi/SDL_hidapi_gamecube.c",
		MAME_DIR .. "3rdparty/SDL2/src/joystick/hidapi/SDL_hidapi_luna.c",
		MAME_DIR .. "3rdparty/SDL2/src/joystick/hidapi/SDL_hidapi_ps3.c",
		...
		MAME_DIR .. "3rdparty/SDL2/src/joystick/hidapi/SDL_hidapi_shield.c",
		MAME_DIR .. "3rdparty/SDL2/src/joystick/hidapi/SDL_hidapi_stadia.c",
		MAME_DIR .. "3rdparty/SDL2/src/joystick/hidapi/SDL_hidapi_steam.c",
		MAME_DIR .. "3rdparty/SDL2/src/joystick/hidapi/SDL_hidapi_steamdeck.c",
		MAME_DIR .. "3rdparty/SDL2/src/joystick/hidapi/SDL_hidapi_switch.c",
		MAME_DIR .. "3rdparty/SDL2/src/joystick/hidapi/SDL_hidapi_wii.c",
		...
		MAME_DIR .. "3rdparty/SDL2/src/SDL_guid.c",
		MAME_DIR .. "3rdparty/SDL2/src/SDL_hints.c",
		MAME_DIR .. "3rdparty/SDL2/src/SDL_hints_c.h",
		MAME_DIR .. "3rdparty/SDL2/src/SDL_list.c",
		MAME_DIR .. "3rdparty/SDL2/src/SDL_log.c",
		MAME_DIR .. "3rdparty/SDL2/src/SDL_utils.c",
		MAME_DIR .. "3rdparty/SDL2/src/stdlib/SDL_crc16.c",
	...
	if _OPTIONS["targetos"]=="macosx" then
		files {
			...
			MAME_DIR .. "3rdparty/SDL2/src/joystick/controller_type.c",
			...
			MAME_DIR .. "3rdparty/SDL2/src/video/cocoa/SDL_cocoavulkan.h",
	...
	configuration { "osx*"}
		buildoptions {
			"-Wno-undef",
			"-USDL_VIDEO_OPENGL_EGL",
			"-USDL_VIDEO_OPENGL_ES2",
			"-USDL_VIDEO_RENDER_OGL_ES2",
			"-USDL_JOYSTICK_MFI",
		}
		buildoptions_objc {
			"-x objective-c",
