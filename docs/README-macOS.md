...
- Added initial YM2149 cart support using A78 header v4 `audio_hi` bit 6 (`YM2149 @ $0800/$0801`).
- Extended cart type detection/selection to YM2149 variants (including POKEY/SuperGame combinations).
- Added YM2149-capable cart device types and mapped YM2149 register writes via `$0800/$0801`.
